        ...
        <section>
            <div
                    ...
                    <h1
                        ...
                        <span class="inline-block">Web
                            <span class="relative whitespace-nowrap text-orange-600">
                                ...
                                <span class="relative">Development</span></span>
                        </span>
                    </h1>
                    <p class="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-800 lg:text-white sm:mt-6">
                        <span class="inline-block">Kami menyediakan jasa pembuatan Web Company Profile dan Custom
                            Website. </span>
                ...
                <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                    <img src="~/assets/images/web-dev.webp" alt="Mobile Development">
                </div>
            </div>
        </section>
    </div>
