            ...
            <div
                ...
                <div class="mr-auto place-self-center lg:col-span-7">
                    <h1
                        ...
                        <span class="inline-block">Video
                            <span class="relative whitespace-nowrap text-pink-600">
                                <svg aria-hidden="true" viewBox="0 0 418 42"
                                    class="absolute top-2/3 left-0 h-[0.58em] w-full fill-pink-300/70"
                                ...
                                <span class="relative">Editor</span></span>
                        </span>
                    </h1>
                    <p class="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-800 lg:text-white sm:mt-6">
                        <span class="inline-block">Kami Menyediakan jasa video editor bahkan content creator untuk
                            bisnis anda. </span>
                ...
                <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                    <img src="~/assets/images/video-editor.webp" alt="Mobile Development">
                </div>
            </div>
        </section>
    </div>
